...
namespace DrawingStarMethod
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            brushList.Add(new SolidBrush(Color.Blue));
        }
        ...
        public void DrawStar(Pen starPen, float x, float y, float pixels)
        {
            ...
            PointF[] star = new PointF[10]; //create PointF array for star points
            ...
            g.DrawPolygon(starPen, star); //draw the star
        ...
        public void FillStar(SolidBrush drawBrush, float x, float y, float pixels)
        {
            ...
            g.FillPolygon(drawBrush, star); //draw the star

        }

        private void blackButton_Click(object sender, EventArgs e)
        {
            drawBrush = brushList[0];
        }

        private void redButton_Click(object sender, EventArgs e)
        {
            drawBrush = brushList[1];
        }

        private void blueButton_Click(object sender, EventArgs e)
        {
            drawBrush = brushList[2];
        }
    }
}
